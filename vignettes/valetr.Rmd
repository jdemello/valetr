...
The `valetr` package provides an R interface to the [Bank of Canada’s
...
See Valet's [documentation](https://www.bankofcanada.ca/valet/docs) for an overview of the data structure.
